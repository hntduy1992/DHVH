...
CREATE TABLE IF NOT EXISTS `activity_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=660 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `khaosat_danhmuc` (
  ...
  `diemChuan` int NOT NULL COMMENT 'Điểm chuẩn xét đạt hay không đạt danh hiệu',
  `trangThai` tinyint DEFAULT '1',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
